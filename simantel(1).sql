...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2020 at 04:50 AM
...
(4, '2020_08_07_133930_create_roles_table', 2),
(5, '2020_08_07_134324_create_role_user_table', 2);
...
(1, 'admin', '2020-08-11 19:49:12', '2020-08-11 19:49:12'),
(2, 'adminb', '2020-08-11 19:49:12', '2020-08-11 19:49:12'),
(3, ' user', '2020-08-11 19:49:12', '2020-08-11 19:49:12');
...
INSERT INTO `tower` (`tower_id`, `kode_kecamatan`, `desa`, `koordinat`, `ketinggian_meter`, `pemilik_tanah`, `izin_tower`, `listrik`, `jalan_meter`, `perumahan`, `jarak_perumahan_meter`, `pagar_tower`, `papan_nama`, `petugas`, `hp_petugas`, `shelter_genset`, `status`) VALUES
...
--
-- Table structure for table `towersurvey`
--

CREATE TABLE `towersurvey` (
  `tower_id` varchar(5) NOT NULL,
  `kode_kecamatan` varchar(10) NOT NULL,
  `desa` varchar(255) NOT NULL,
  `koordinat` varchar(50) NOT NULL,
...
--
-- Dumping data for table `towersurvey`
--

INSERT INTO `towersurvey` (`tower_id`, `kode_kecamatan`, `desa`, `koordinat`, `ketinggian_meter`, `pemilik_tanah`, `izin_tower`, `listrik`, `jalan_meter`, `perumahan`, `jarak_perumahan_meter`, `pagar_tower`, `papan_nama`, `petugas`, `hp_petugas`, `shelter_genset`, `status`) VALUES
('01001', '150401', 'DESA BENTENG RENDAH KEC. 150401', 'E 00149189 N 01314340', 72, 'HAVIS', '503.7/ SK. 46/ SIMB/ DPMPTSP', 'Y', 25, 'Y', 10, 'Y', 'N', '', '', 'Y', ''),
('01002', '150401', 'RT.13 DS. PEMATANG GADUNG', 'E 00143187 N 01316814', 45, 'M SAFI\'I', '503.7/ SK. 44/ SIMB/ DPMPTSP', 'Y', 50, 'Y', 10, 'Y', 'Y', 'M SAFI\'I', '85838633836', 'Y', ''),
('01003', '150401', 'RT. 09 KEL. KEMBANG PASEBAN', 'E 00145168 N 01315130', 72, 'RIDWAN', '', 'Y', 35, 'Y', 10, 'Y', 'N', '', '', 'Y', ''),
('01004', '150401', 'RT 12 KEL. KEMBANG PASEBAN', 'E 00745438 N 01315163', 72, 'H SYAUGI SOFI', '', 'Y', 20, 'Y', 15, 'Y', 'N', 'MUNIR', '', 'Y', ''),
...
(1, 'Admin User', NULL, '$2y$10$fz/wPrnWALgz8Nq.D7ECnOHhN5mbLJmITBZlr9VGC0iyfXowgrXGC', NULL, '2020-08-11 19:49:13', '2020-08-11 19:49:13'),
(2, 'Adminb User', NULL, '$2y$10$5Eda1bU7MV43XvRc6bGYtuxwN7upU7PnYp.Joep7hZwVAerzkR5kK', NULL, '2020-08-11 19:49:13', '2020-08-11 19:49:13');
...
--
-- Indexes for table `towersurvey`
--
ALTER TABLE `towersurvey`
  ADD PRIMARY KEY (`tower_id`),
  ADD KEY `FK_Kecamatan` (`kode_kecamatan`);
