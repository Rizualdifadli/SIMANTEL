...
<h3 class="text-center">FOTO TOWER <?php echo e($x->tower_id); ?></h3>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src=" <?php echo e(asset( 'storage/'. $x->gambar)); ?>" class="d-block w-100" alt="...">
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SIMANTEL\resources\views//fotoadmin.blade.php ENDPATH**/ ?>