...
<div class="form-group col-md-12">
  ...
  <div class="form-group col-md-2">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="izin_tower" value="<?php echo e($x->izin_tower); ?>">
      <label for="exampleInputPassword1">TENGGAT IZIN</label>
      <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tenggat_izin" value="<?php echo e($x->tenggat_izin); ?>">
      <label for="exampleInputPassword1">BILL UNPAID</label>
      <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="bill" value="<?php echo e($x->bill); ?>">
  </div>
  <div class="form-group col-md-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\SIMANTEL\resources\views//edit.blade.php ENDPATH**/ ?>